		...
		<view class="page-body">
				...
				<view class="category-list">
					<checkbox-group @change="onCategoryChange">
						<label class="category-item" v-for="item in categoryList" :key="item.categoryId">
							<checkbox :value="String(item.categoryId)"
			...
			<view class="form-item">
				...
				<view class="editor-box" style="height: 500px;">
					<sp-editor editorId="editor" :toolbar-config="toolbarConfig" @input="inputOver"
						@upinImage="upinImage" @init="initEditor"></sp-editor>
				</view>
			</view>
		</view>
...
const toolbarConfig = ref({
	iconSize: '16px',
	iconColumns: 10,
	keys: ["header", "H1", "H2", "H3", "bold", "italic", "underline", "strike", "align", "alignLeft", "alignCenter", "color", "backgroundColor", "image",]
})
//图片上传相关配置
const signature = ref('')
