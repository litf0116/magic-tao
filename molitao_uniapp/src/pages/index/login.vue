        ...
        <view class="login-container h-[100vh] px-4 relative flex flex-col">
            ...
            <view class="flex-1 flex flex-col justify-center w-full max-w-md mx-auto">
                <view class="form-container bg-white rounded-2xl shadow-lg p-6 mb-6">
                    ...
                    <view class="mt-6 flex items-center justify-center">
                        <view class="flex items-center" @tap="togglePrivacy">
                            <view class="w-5 h-5 rounded border-2 border-gray-300 flex items-center justify-center mr-2" :class="{ 'bg-green-500 border-green-500': agreePrivacy }">
