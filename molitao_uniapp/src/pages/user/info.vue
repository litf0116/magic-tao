	...
	<view class="p-4 bg-white">
		<uv-form ref="formRef" labelPosition="top" :model="form" :rules="rules">
			...
			<uv-form-item :labelWidth="220" label="头像" prop="headImgUrl" borderBottom>
				<uv-upload accept="image" :fileList="fileList1" :multiple="false" :maxCount="1" width="200rpx"
					height="200rpx" @after-read="afterRead" @delete="deletePic"></uv-upload>
			</uv-form-item>
			<uv-form-item :labelWidth="220" label="昵称" prop="name" borderBottom>
				<uv-input v-model="form.name" placeholder="请输入昵称"></uv-input>
			</uv-form-item>
			<template v-if="form.id">
				<uv-form-item v-for="x in extItems" :key="x.prop" :labelWidth="220" :label="x.label" :prop="x.prop"
					borderBottom>
