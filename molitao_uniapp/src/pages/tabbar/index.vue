<template>
	<view class="container">
		...
		<view class="component-page" style="height: 100%;">
			...
			<tradingPost ref="tradingPostRef" v-if="current == 2" @updateModalConfig="updateModal"></tradingPost>
			<contacts ref="contactsRef" v-if="current == 3" @refreshCurrentVal="getUserFriendCount"></contacts>
		...
		<custom-modal style="z-index: 99999;" v-model:show="modalConfig.show" :title="modalConfig.title"
			:showCancel="modalConfig.showCancel" :cancelText="modalConfig.cancelText"
			:confirmText="modalConfig.confirmText" @cancel="onCancel" @confirm="onConfirm">
