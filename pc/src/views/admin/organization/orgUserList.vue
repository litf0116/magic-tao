<template>
    ...
    <PagedTable ref="table" :fetch-function="fetchData">
        <el-table-column type="selection" width="50" v-permission="'UserManagment.OrganizationManager'" />
        <el-table-column prop="userName" label="用户名" />
        <el-table-column prop="name" label="姓名" />
        <el-table-column prop="phoneNumber" label="手机" />
    </PagedTable>
    <div class="mt-2 space-x-2" v-permission="'UserManagment.OrganizationManager'">
