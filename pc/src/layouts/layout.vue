<template>
    <main class="min-h-screen">
        <div class="wrap">
            <div class="header">
                <img class="logo2" :src="'http://image.molitao.top/20250330/gg4hck6wkx2ndrn46dbw0lcxwh5ik0hi.png'" />
            </div>
            <public-nav />
...
.wrap {
    ...
    .header {
        ...
        background: url('http://image.molitao.top/20250330/04j40l4ynlbh3v3h4bgfe7j2pxiqjg8d.png') no-repeat center top / cover;
