						...
						<div class="menu-box">
							...
							<div>
								<div class="mb-4 text-center cursor-pointer">
									<div class="i-carbon:settings size-7 text-gray-500 hover:text-gray-700"
										@click="openSetting" />
								</div>
...
.wrap {
	...
	.header {
		...
		background: url(hhttps://cdn.molitao.top/20250330/04j40l4ynlbh3v3h4bgfe7j2pxiqjg8d.png) no-repeat;
