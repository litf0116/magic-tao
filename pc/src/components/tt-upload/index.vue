<template>
	<el-upload :class="cssClass" :multiple="false" :drag="drag" :action="actionUrl" :file-list="fileList"
		:show-file-list="showFileList" :data="uploadData" :on-success="handleSuccess" :before-upload="beforeUpload"
		:list-type="listType" :on-remove="handleRemove" :on-preview="handlePictureCardPreview">
		<slot />
		<template #file="{ file }">
