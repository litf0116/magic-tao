<template>
    <el-dialog v-model="dialogVisible" title="消息配置" width="600px" draggable destroy-on-close append-to-body
        :close-on-click-modal="false">
        <el-form ref="formRef" :model="formFields" :rules="formRules" style="max-width: 800px" label-width="auto"
