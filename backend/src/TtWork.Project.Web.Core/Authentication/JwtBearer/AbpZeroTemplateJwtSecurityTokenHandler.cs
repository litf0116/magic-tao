...
namespace TtWork.Project.Web.Authentication.JwtBearer {
    public class AbpZeroTemplateJwtSecurityTokenHandler : ITransientDependency, ISecurityTokenValidator {
        ...
        public JwtSecurityTokenHandler GetTokenHandler => this._tokenHandler;
        ...
        private static async Task
            ValidateSecurityStampAsync(ISettingManager settingManager, ClaimsPrincipal principal) {
