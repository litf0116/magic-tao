...
using TtWork.Project.Applications.MultiTenancy.Dto;
using TtWork.Project.MultiTenancy.Dto;

namespace TtWork.Project.Applications.MultiTenancy {
    [AbpAuthorize(AppPermissions.Administration)]
    public class TenantAppService : AsyncCrudAppService<Tenant, TenantDto, int, PagedTenantResultRequestDto,
