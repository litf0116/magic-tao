...
/// 用户保证金记录表
/// </summary>
[Table("Pays_UserDepositLog")]
public class UserDepositLog : FullAuditedAggregateRoot<Ulid>, IMustHaveTenant, IExtendableObject {
    public UserDepositLog(BalanceLogType type, decimal amount, string reason = null) {
        Id = Ulid.NewUlid();
        Type = type;
        Amount = amount;
        Reason = reason;
...
[AutoMapFrom(typeof(UserDepositLog))]
public class UserDepositLogDto : EntityDto<Ulid> {
