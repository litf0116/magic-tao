...
public static class ImHelper {
    ...
    /// <returns>websocket 地址：ws://url/ws?token=xxx</returns>
    public static string PrevConnectServer(long clientId, string clientMetaData) =>
        Instance.PrevConnectServer(clientId, clientMetaData);
    ...
    public static void SendMessage(long senderClientId, List<long> receiveClientId, ChatMessage message,
        bool receipt = false) =>
        Instance.SendMessage(new MessageEvent(senderClientId, receiveClientId, message, receipt));
    ...
    public static void EventBus(
        ...
        Action<TokenEvent> offline) => Instance.EventBus(online, offline);
    ...
    public static void JoinChan(long clientId, string chan) => Instance.JoinChan(clientId, chan);
    ...
    public static void DeleteChan(string chan) => Instance.DeleteChan(chan);
