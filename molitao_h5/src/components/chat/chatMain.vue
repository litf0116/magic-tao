<template>
    <view class="chatInterface" @contextmenu.prevent="">
        <view id="scrollview" class="scroll-view">
            <image v-if="history.loading" class="history-loaded" src="/h5/static/images/loading.svg" />
        ...
        <view class="action-box">
            <view class="action-top">
                ...
                <view @click="switchEmojiKeyboard">
                    <image v-if="emoji.visible" class="more" src="/h5/static/images/jianpan.png"></image>
                    <image v-else class="more" src="/h5/static/images/emoji.png"></image>
                </view>
                <view>
                    <image class="more" src="/h5/static/images/more.png" @click="showOtherTypesMessagePanel()" />
                </view>
            ...
            <view v-if="otherTypesMessagePanelVisible" class="action-bottom relative">
                ...
                <view class="more-icon">
                    <image class="operation-icon" src="/h5/static/images/picture.png" @click="sendImageMessage2()"></image>
